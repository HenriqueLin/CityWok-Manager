...
def upgrade():
    ...
    sa.Column('id_type', sqlalchemy_utils.types.choice.ChoiceType(length=255), nullable=False),
    sa.Column('id_number', sa.String(), nullable=False),
    sa.Column('id_validity', sa.Date(), nullable=False),
    sa.Column('nationality', sqlalchemy_utils.types.country.CountryType(length=2), nullable=False),
    ...
    sa.Column('total_salary', citywok_ms.utils.models.SqliteDecimal(), nullable=True),
    sa.Column('taxed_salary', citywok_ms.utils.models.SqliteDecimal(), nullable=True),
